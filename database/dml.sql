...
INSERT OR REPLACE INTO "AppConfig" ("key", "value", "category", "label", "description", "isSecret", "updatedBy", "updatedAt") VALUES
  ...
  ('secrets.sshUsername', '', 'SECRETS', 'SSH Username', 'SSH service account username', 0, 'seed', CURRENT_TIMESTAMP),
  ('secrets.sshPassword', '', 'SECRETS', 'SSH Password', 'SSH service account password', 1, 'seed', CURRENT_TIMESTAMP),
  ('secrets.sshTotpSecret', '', 'SECRETS', 'SSH TOTP Secret', 'TOTP secret for 2FA SSH auth', 1, 'seed', CURRENT_TIMESTAMP),
  ('secrets.slackWebhookUrl', '', 'SECRETS', 'Slack Webhook URL', 'Slack incoming webhook URL for notifications', 1, 'seed', CURRENT_TIMESTAMP),
  ('secrets.masterUsername', '', 'SECRETS', 'Master Username', 'Break-glass admin username', 0, 'seed', CURRENT_TIMESTAMP),
  ('secrets.masterPasswordHash', '', 'SECRETS', 'Master Password Hash', 'Break-glass admin bcrypt hash', 1, 'seed', CURRENT_TIMESTAMP),
