...
async function main() {
  ...
  const configDefaults: Array<{
    ...
    { key: 'secrets.smtpTlsEnabled',   value: 'false',                   category: 'SECRETS', label: 'SMTP TLS Enabled',      description: 'Require TLS/STARTTLS for SMTP (ignored for Mailpit on 127.0.0.1:1025)', isSecret: false },
    { key: 'secrets.smtpTlsRejectUnauthorized', value: 'true',          category: 'SECRETS', label: 'SMTP TLS Verify Certs', description: 'Validate SMTP server certificate when SMTP TLS Enabled is true', isSecret: false },
    ...
    { key: 'infra.sshPendingFolderPath', value: '/mount/RWS4/batch_jobs/in', category: 'INFRA', label: 'Pending IN Folder',     description: 'Remote path for pending upload files' },
    ...
    { key: 'engine.db2ConnectorTimeoutMs', value: '120000', category: 'ENGINE', label: 'DB2 Connector Timeout (ms)', description: 'DB2 java child process timeout' },
    { key: 'engine.db2ConnectorMaxBuffer',   value: '10485760', category: 'ENGINE', label: 'DB2 Connector Max Buffer', description: 'DB2 java stdout max buffer size in bytes' },
