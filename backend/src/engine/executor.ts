    ...
    try {
      ...
      await prisma.jobExecution.update({
        ...
        data: {
          ...
          output: result.output?.substring(0, configService.getInt('engine.maxOutputChars', 50000)),
          errorMessage: result.errorMessage?.substring(0, configService.getInt('engine.maxErrorChars', 10000)),
