...
echo "  mkdir -p ./data/sqlite/prisma"
echo "  $COMPOSE -f docker-compose.prod.yml -f docker-compose.prod-hostdb.yml up -d"
echo "  curl http://localhost:4015/health"
echo "  curl -I http://localhost:3015"
